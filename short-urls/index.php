                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <table class="table mt-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td><?= $row->url; ?></td>
                            <td><a href="http://localhost/short-urls/u?id=<?= $row->id; ?>" target="_blank">http://localhost/short-urls/u?id = <?= $row->id; ?></a></td>
                            <td><?= $row->clicks; ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
